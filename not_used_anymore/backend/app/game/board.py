...
from app.game.entities.hex_tile import HexTile
from app.game.entities.node import Node
from app.game.entities.edge import Edge
from app.game.entities.resource_type import ResourceType, build_resources, NUMBERS
...
class Board:
    ...
    def _generate_tiles(self) -> List[HexTile]:
        ...
        # axial coordinates for 7-hex board (center + 6 neighbors)
        positions = [
            (0, 0),  # center
            (0, -1),  # top-left
            (1, -1),  # top-right
    ...
    def _generate_edges(
        ...
        for tile in self.tiles:
            ...
            for i in range(6):
                ...
                # order-independent key (same edge for both adjacent hexes)
